...
const values = [
  ...
  // },
  {
    ...
    desc: "We celebrate the rich cultural diversity of South Sudan while promoting solidarity and mutual respect among all tribes.",
    bg: "bg-emerald-50",
  ...
  // },
  {
    ...
    desc: " We are committed to implementing initiatives that not only address immediate needs but also ensure long-term benefits for communities and the environment.",
    bg: "bg-orange-50",
  ...
  // },
  {
    icon: <FaHeart />,
    title: "Integrity",
    desc: "We operate transparently and ethically, ensuring that our actions align with our mission and values.",
    bg: "bg-blue-50",
    color: "text-blue-600",
  },
  {
    icon: <FaGavel />,
    title: "Justice ",
    desc: "We uphold the rule of law and advocate for legal reforms to protect human rights and promote accountability",
    bg: "bg-orange-50",
    color: "text-orange-500",
  },
];
