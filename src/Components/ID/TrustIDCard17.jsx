...
import profile from "../../assets/Nyamuoch-kuey-gach.png";

export default function TrustIDCard17  () {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      <div className="
        ...
        font-medium
      ">
        <p><span className="font-bold">ID No:-</span> 017</p>
        <p><span className="font-bold">Gender:-</span> Female</p>
        <p><span className="font-bold">Nationality:-</span> South Sudanese</p>
        <p><span className="font-bold">Location:-</span> Rotational</p>
        <p><span className="font-bold">Phone:-</span> +211928763377</p>
        <p><span className="font-bold">E-mail:-</span> nyamuochkueygach@gmail.com</p>
      </div>
