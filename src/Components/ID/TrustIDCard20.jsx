...
import profile from "../../assets/nhial jock bol.jpg";

export default function TrustIDCard20() {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      <div className="
        ...
        font-medium
      ">
        <p><span className="font-bold">ID No:-</span> 020</p>
        ...
        <p><span className="font-bold">Phone:-</span> +211919072553 </p>
        <p><span className="font-bold">E-mail:-</span>nhialjockbol77@gmail.com</p>
      </div>
