...
import profile from "../../assets/james-toang.png";

export default function TrustIDCard12() {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      <div className="
        ...
        font-medium
      ">
        <p><span className="font-bold">ID No:-</span> 012</p>
        ...
        <p><span className="font-bold">Phone:-</span> +211926884534</p>
        <p><span className="font-bold">E-mail:-</span> toang749@gmail.com</p>
      </div>
