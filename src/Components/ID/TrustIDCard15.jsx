...
import profile from "../../assets/Chuol-puar-chuol.png";

export default function TrustIDCard15  () {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      <div className="
        ...
        font-medium
      ">
        <p><span className="font-bold">ID No:-</span> 015</p>
        <p><span className="font-bold">Gender:-</span> Male</p>
        <p><span className="font-bold">Nationality:-</span> South Sudanese</p>
        <p><span className="font-bold">Location:-</span> Nasir County</p>
        <p><span className="font-bold">Phone:-</span> +211917258415</p>
        <p><span className="font-bold">E-mail:-</span> chuolpuarchuol6@gmail.com</p>
      </div>
