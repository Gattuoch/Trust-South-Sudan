...
import profile from "../../assets/david-bidong.png";

export default function TrustIDCard02() {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      <div className="
        ...
        font-medium
      ">
        <p><span className="font-bold">ID No:-</span> 002</p>
        ...
        <p><span className="font-bold">Phone:-</span> +211911924887</p>
        <p><span className="font-bold">E-mail:-</span> nhialluom@gmail.com</p>
      </div>
