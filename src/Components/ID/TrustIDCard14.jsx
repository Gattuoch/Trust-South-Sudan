...
import profile from "../../assets/jal-ruot .png";

export default function TrustIDCard14() {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      ">
        ...
        <p><span className="font-bold">Phone:-</span> +211911743455</p>
        <p><span className="font-bold">E-mail:-</span> gjalruot@gmail.com</p>
      </div>
