...
import profile from "../../assets/gattuoch-chambang.png";

export default function TrustIDCard11() {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      <div className="
        ...
        font-medium
      ">
        <p><span className="font-bold">ID No:-</span> 011</p>
        ...
        <p><span className="font-bold">Phone:-</span> +211918505110</p>
        <p><span className="font-bold">E-mail:-</span> gchambang@gmail.com</p>
      </div>
