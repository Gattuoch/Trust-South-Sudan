...
import profile from "../../assets/david-dak.png";

export default function TrustIDCard01() {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      <div className="
        ...
        font-medium
      ">
        <p><span className="font-bold">ID No:-</span> 001</p>
        ...
        <p><span className="font-bold">Phone:-</span> +211927863377</p>
        <p><span className="font-bold">E-mail:-</span> daviddak72@gmail.com</p>
      </div>
