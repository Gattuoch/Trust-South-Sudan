...
import profile from "../../assets/Buay Wal.png";

export default function TrustIDCard22() {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      <div className="
        ...
        font-medium
      ">
        <p><span className="font-bold">ID No:-</span> 022</p>
        ...
        <p><span className="font-bold">Phone:-</span> +211988700018</p>
        <p><span className="font-bold">E-mail:-</span>buaydeng216@gmail.com</p>
      </div>
