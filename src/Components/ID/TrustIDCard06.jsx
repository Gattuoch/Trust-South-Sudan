...
import profile from "../../assets/maar-naath.png";

export default function TrustIDCard06() {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      <div className="
        ...
        font-medium
      ">
        <p><span className="font-bold">ID No:-</span> 006</p>
        ...
        <p><span className="font-bold">Phone:-</span> +211929925570</p>
        <p><span className="font-bold">E-mail:-</span> maarnaathkoryomgil@gmail.com</p>
      </div>
