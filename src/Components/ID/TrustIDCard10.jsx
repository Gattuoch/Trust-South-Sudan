...
import profile from "../../assets/changkuoth-riek.png";

export default function TrustIDCard10() {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      <div className="
        ...
        font-medium
      ">
        <p><span className="font-bold">ID No:-</span> 010</p>
        ...
        <p><span className="font-bold">Phone:-</span> +211927658578</p>
        <p><span className="font-bold">E-mail:-</span> changkuothriekgoak@gmail.com</p>
      </div>
