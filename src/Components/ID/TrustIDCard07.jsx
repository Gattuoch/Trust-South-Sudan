...
import profile from "../../assets/nyanhial-gatkuoth .png";

export default function TrustIDCard07() {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      <div className="
        ...
        font-medium
      ">
        <p><span className="font-bold">ID No:-</span> 007</p>
        ...
        <p><span className="font-bold">Phone:-</span> +211920035759</p>
        <p><span className="font-bold">E-mail:-</span> ____</p>
      </div>
