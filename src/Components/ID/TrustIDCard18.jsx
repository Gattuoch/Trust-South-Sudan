...
import profile from "../../assets/nyabel deng koda.jpg";

export default function TrustIDCard18() {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      <div className="
        ...
        font-medium
      ">
        <p><span className="font-bold">ID No:-</span> 018</p>
        ...
        <p><span className="font-bold">Phone:-</span> +211921095158 </p>
      </div>
