...
import profile from "../../assets/pal-khot.png";

export default function TrustIDCard014 () {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      <div className="
        ...
        font-medium
      ">
        <p><span className="font-bold">ID No:-</span> 014</p>
        ...
        <p><span className="font-bold">Phone:-</span> +211921838318</p>
        <p><span className="font-bold">E-mail:-</span>palkhot2017@gmail.com</p>
      </div>
