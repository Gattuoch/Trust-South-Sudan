...
import profile from "../../assets/thijin khan reath.jpg";

export default function TrustIDCard19() {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      <div className="
        ...
        font-medium
      ">
        <p><span className="font-bold">ID No:-</span> 019</p>
        <p><span className="font-bold">Gender:-</span> male</p>
        <p><span className="font-bold">Nationality:-</span> South Sudanese</p>
        <p><span className="font-bold">Location:-</span> Akobo</p>
        <p><span className="font-bold">Phone:-</span> +211926445799 </p>
        <p><span className="font-bold">E-mail:-</span>thijin2014@gmail.com</p>
      </div>
