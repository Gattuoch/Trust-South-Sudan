...
import profile from "../../assets/gatluak buony.png";

export default function TrustIDCard21() {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      <div className="
        ...
        font-medium
      ">
        <p><span className="font-bold">ID No:-</span> 021</p>
        <p><span className="font-bold">Gender:-</span> male</p>
        <p><span className="font-bold">Nationality:-</span> South Sudanese</p>
        <p><span className="font-bold">Location:-</span> Jonglei State</p>
        <p><span className="font-bold">Phone:-</span> +211910106600 </p>
        <p><span className="font-bold">E-mail:-</span>Gatluakbuny@gmail.com</p>
      </div>
