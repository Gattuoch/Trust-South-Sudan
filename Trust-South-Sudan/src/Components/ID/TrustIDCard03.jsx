...
import profile from "../../assets/gatwech-chang.png";

export default function TrustIDCard03() {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      <div className="
        ...
        font-medium
      ">
        <p><span className="font-bold">ID No:-</span> 003</p>
        ...
        <p><span className="font-bold">Phone:-</span> +211920204266</p>
        <p><span className="font-bold">E-mail:-</span> gatwechchang7@gmail.com</p>
      </div>
