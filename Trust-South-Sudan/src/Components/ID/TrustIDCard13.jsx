...
import profile from "../../assets/kayier-yout.png";

export default function TrustIDCard13() {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      <div className="
        ...
        font-medium
      ">
        <p><span className="font-bold">ID No:-</span> 013</p>
        ...
        <p><span className="font-bold">Phone:-</span> +211911864343</p>
        <p><span className="font-bold">E-mail:-</span> kaieryoutbayiek@gmail.com</p>
      </div>
