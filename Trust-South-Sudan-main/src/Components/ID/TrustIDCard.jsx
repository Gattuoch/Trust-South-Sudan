...
import profile from "../../assets/NyaliepKuany.png";

export default function TrustIDCard() {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      <div className="
        ...
        font-medium
      ">
        <p><span className="font-bold">ID No:-</span> 005</p>
        ...
        <p><span className="font-bold">Phone:-</span> +211923530059</p>
        <p><span className="font-bold">E-mail:-</span> Nyaliepstephenk@gmail.com</p>
      </div>
