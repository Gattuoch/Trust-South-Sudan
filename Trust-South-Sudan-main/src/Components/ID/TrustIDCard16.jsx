...
import profile from "../../assets/stephen-kuel.png";

export default function TrustIDCard16 () {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      <div className="
        ...
        font-medium
      ">
        <p><span className="font-bold">ID No:-</span> 016</p>
        ...
        <p><span className="font-bold">Phone:-</span> +211914236905</p>
        <p><span className="font-bold">E-mail:-</span>kueldeng2014@gmail.com</p>
      </div>
