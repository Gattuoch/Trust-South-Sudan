...
import profile from "../../assets/banak-bidong.png";

export default function TrustIDCard04() {
  return (
    <div className="
      w-full 
      max-w-[470px] 
    ...
    ">
      ...
      <div className="
        ...
        text-center
      ">
        Admin and Constitutional Affair
      </div>
      ...
      <div className="
        ...
        font-medium
      ">
        <p><span className="font-bold">ID No:-</span> 004</p>
        ...
        <p><span className="font-bold">Phone:-</span> +211922423505</p>
        <p><span className="font-bold">E-mail:-</span> chawachbanak@gmail.com</p>
      </div>
